...
public class DesignCircularDeque641 {
    ...
    public static void main(String[] args) {
        ...
        DesignCircularDeque641 designCircularDeque641 = new DesignCircularDeque641(5);

        designCircularDeque641.insertFront(11);
        designCircularDeque641.insertFront(22);
        designCircularDeque641.insertFront(33);
        designCircularDeque641.insertFront(44);
        designCircularDeque641.insertFront(55);


        System.out.println(designCircularDeque641.getFront());
